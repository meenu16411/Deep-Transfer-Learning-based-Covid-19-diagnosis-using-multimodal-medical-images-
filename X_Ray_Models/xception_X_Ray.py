# -*- coding: utf-8 -*-
"""Xception_Xray_MSc.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1nBk_xjRKFvD4xAKmfzsrlrj-y74tVm-n
"""
...
noncovid_files_pr= glob(noncovid_path + '/*')
noncovid_files =noncovid_files_pr[0:2500]
...
def plot_images(images, title):
    ...
    plt.show()
plot_images(covid_images, 'Positive COVID-19 Xrays ')
plot_images(noncovid_images, 'Negative COVID-19 Xrays')
...
model.save('xception_Xray1.h5')
model.save_weights('xception_weights_Xray1.hdf5')

# Load saved model
model = load_model('xception_Xray1.h5')
